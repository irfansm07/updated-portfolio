    ...
    <div className={cn("tk-container", className)} {...props}>
      <style>{`
        ...
        .tk-main {
          ...
          transform: scale(${scale}) translateX(-40px) translateY(35px);
          transform-origin: center center;
          transition: transform 0.3s ease;
          pointer-events: auto;
        }
        @media (max-width: 1200px) {
          .tk-container { height: 420px; }
          .tk-main { transform: scale(${scale * 0.85}) translateX(-40px) translateY(35px); }
        }
        @media (max-width: 1024px) {
          .tk-container { height: 450px; }
          .tk-main { transform: scale(0.7) translateX(-40px) translateY(35px); }
        }
        @media (max-width: 768px) {
          .tk-container { height: 360px; }
          .tk-main { transform: scale(0.55) translateX(-40px) translateY(35px); }
        }
        @media (max-width: 480px) {
          .tk-container { height: 280px; }
          .tk-main { transform: scale(0.45) translateX(-40px) translateY(35px); }
        }
